...
@Component({
  selector: 'page-menudistribuidorproducto',
  templateUrl: 'menudistribuidorproducto.html',
})
export class MenudistribuidorproductoPage {
  ...
  enlace_producto_agotado(){
    ...
    this.navCtrl.push(MenudistribuidoragotadosPage);
